function openWindow() {
  ...
  switch (unknown) {
    case "E":
      window.open("E.html", "_self");
      break
    case "EK":
      window.open("EK.html", "_self");
      break
    case "EP":
      window.open("EP.html", "_self");
      break
    case "road":
...
function calculate() {
  ...
  var unknown3 = document.getElementById("unknown3") ? document.getElementById("unknown3").value : "";
  ...
  var known3 = document.getElementById("known3") ? document.getElementById("known3").value : "";
  switch (unknown) {
    case "road":
    ...
    case "EK":
      var m = unknown1 == "kg" ? known1 * 1000 : known1;
      var v = unknown2 == "km" ? known2 * 0.277777778 : known2;
      if (m && v) {
        var EK = (m * v) / 2;
        alert("Կինետիկ Էներգիան = " + EK);
        break
      } else {
        alert("Խնդրում եմ լրացրեք 2 վանդակները");
        break
    ...
    case "EP":
      var g = known1;
      var m = unknown2 == "kg" ? known2 * 1000 : known2;
      var h = unknown3 == "km" ? known3 * 1000 : known3;
      if (m && g) {
        var EP = m * g * h;
        alert("Պոտենցիալ Էներգիան = " + EP);
        break
      } else {
        alert("Խնդրում եմ լրացրեք բոլոր վանդակները");
        break
      }
